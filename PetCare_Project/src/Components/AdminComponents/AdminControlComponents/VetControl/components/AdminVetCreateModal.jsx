...
import "./adminVetCreateModal.scss";
import {
  CitiesOptions,
  petTypesOptions,
} from "../../../../SignUp/signUpDatas/signUpDatas";
import { adminVetCreateFetch } from "../../../../../AxiosFetchs/AdminsFetchs/VetsControlFetchs/AdminVetCreateFetch";

const AdminVetCreateModal = ({ closeModal, isModalOpen }) => {
  ...
  const onFinish = async (values) => {
    try {
      console.log(values);
      const response = await adminVetCreateFetch(values);
            ...
            <div className="inputs">
              ...
              <div className="half-part">
                ...
                <Form.Item
                  ...
                  label="About"
                  rules={[
                    { required: true, message: "This place is required!" },
                  ]}
                >
...
export default AdminVetCreateModal;
