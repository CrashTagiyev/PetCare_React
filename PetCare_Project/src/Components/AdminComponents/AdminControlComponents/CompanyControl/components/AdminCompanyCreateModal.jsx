...
import { adminCompanyCreatFetch } from "../../../../../AxiosFetchs/AdminsFetchs/CompanyControlFetchs/AdminCompanyCreatFetch";

const AdminCompanyCreateModal = ({closeModal,isModalOpen}) => {
...
export default AdminCompanyCreateModal